...
export class Ec2ComponentTemplate extends Template {
    ...
    public constructor(callback) {
        super(callback);
        this.name = 'EC2 Component';
        this.type = 'Ec2ComponentTemplate';
    }
    ...
    public clone() {
        let obj = new Ec2ComponentTemplate(this.callback);
